const projects = [
  {
    ...
    title: "Task List",
    description:
      "Discover the ease of an Interactive To-Do List app created with React.js. Manage tasks effortlessly, add items, mark as complete for a seamless user experience. The clean interface ensures an appealing, efficient way to stay organized and boost productivity.",
    language: "React.js",
    isComponent: true,
    images: [],
  },
